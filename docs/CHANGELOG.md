...
- **README rewritten** to be a fuller front door to the project: chapter-by-chapter contents, tooling/tech stack, how the pieces cross-check each other, and what is and isn't included in the public GitHub copy of this project.
...
## 2026-07-28 - Interview prep guide added

`07_Interview_Prep/08_Interview_Prep_Master_Guide.docx` added: a Q&A-style walkthrough of the deal book for interview prep. Kept out of the public GitHub copy of this project (see `README.md`).
